...
Order Service - E-commerce Order Management with PostgreSQL
    ...
    try:
            ...
            for key, value in headers.items():
                if key.lower() == 'traceparent':
                    ...
                    if len(parts) == 4 and parts[0] == '00':
                        ...
                        print(f"🔧 Order Service - Manually parsed trace_id: {manual_trace_id}")
                        break
        ...
        if incoming_context:
            ...
            if current_span and current_span.is_recording():
                ...
                print(f"✅ Order Service - Joined via propagator: {trace_id}")
        ...
        if manual_trace_id and manual_span_id:
            ...
            try:
                ...
                print(f"✅ Order Service - Manually joined trace: {manual_trace_id}")
                return token, False
        ...
        print("⚠️ Order Service - Starting root trace (no parent)")
        return None, True
...
def get_popular_products():
    ...
    try:
        ...
        # Start main span
        with tracer.start_as_current_span("order_service.get_popular_products") as main_span:
            main_span.set_attribute("service.component", "order_service")
            main_span.set_attribute("service.name", "order-service")
...
def create_order():
    ...
    try:
        ...
        # Start main span
        with tracer.start_as_current_span("order_service.create_order") as main_span:
            main_span.set_attribute("service.component", "order_service")
            main_span.set_attribute("service.name", "order-service")
            main_span.set_attribute("db.system", "postgresql")
...
if __name__ == '__main__':
    print("📋 Order Service (E-commerce - PostgreSQL) starting...")
